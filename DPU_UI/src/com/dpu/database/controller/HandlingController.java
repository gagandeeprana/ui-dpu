...
//				public void run() {
//					try {
//						String response = GetAPIClient.callGetAPI(Iconstants.URL_SERVER + Iconstants.URL_HANDLING_API + "/" + searchHandling + "/search", null);
...
//				public void run() {
//					try {
//						String response = GetAPIClient.callGetAPI(Iconstants.URL_SERVER + Iconstants.URL_HANDLING_API, null);
//						fillHandling(response);
//					} catch (Exception e) {
//						JOptionPane.showMessageDialog(null, "Try Again.." , "Info", 1);
//					}
...
//					try {
//						ObjectMapper mapper = new ObjectMapper();
//						String response = GetAPIClient.callGetAPI(Iconstants.URL_SERVER + Iconstants.URL_HANDLING_API + "/" + handling.getId(), null);
//						if(response != null && response.length() > 0) {
//							HandlingModel c = mapper.readValue(response, HandlingModel.class);
...
//		try {
//			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource(Iconstants.HANDLING_BASE_PACKAGE + Iconstants.XML_HANDLING_EDIT_SCREEN));
//			
...
//		try {
//			FXMLLoader fxmlLoader = new FXMLLoader(HandlingController.class.getClassLoader().getResource(Iconstants.HANDLING_BASE_PACKAGE + Iconstants.XML_HANDLING_ADD_SCREEN));
//			
//	        Parent root = (Parent) fxmlLoader.load();
//	        
//	        Stage stage = new Stage();
...
//				public void run() {
//					try {
//						String response = DeleteAPIClient.callDeleteAPI(Iconstants.URL_SERVER + Iconstants.URL_HANDLING_API + "/" + handling.getId(), null);
//						try {
...
//		
//		handling.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<HandlingModel,String>, ObservableValue<String>>() {
//			
//			@Override
